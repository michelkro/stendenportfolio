...
--
-- Host: 127.0.0.1
-- Gegenereerd op: 03 jan 2017 om 20:10
...
--
-- Tabelstructuur voor tabel `menu_button`
--

CREATE TABLE `menu_button` (
  `Menu_ID` int(4) NOT NULL,
  `Page_ID` int(4) NOT NULL,
  `Menu_Button_Name` varchar(50) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
-- Indexen voor tabel `menu_button`
--
...
--
-- AUTO_INCREMENT voor een tabel `menu_button`
--
ALTER TABLE `menu_button`
