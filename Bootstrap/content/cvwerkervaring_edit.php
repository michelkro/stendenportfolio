                            ...
                            } else
                            {
                                ...
                                } else
                                {
                                    ...
                                    } else
                                    {
                                        ...
                                        echo"<div id='form'>";
                                        echo "<form method='POST' action='?page=cvwerkervaring_done&ID=" . $row['User_ID'] . "'>";
                                        while ($item2 = mysqli_fetch_assoc($QueryResult))
                                        {

                                            echo "<p>Werkervaring:<textarea rows='10' cols='100' name='werkervaring'>" . $item2['Werkervaring'] . "</textarea></p>";
