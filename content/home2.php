  ...
  <head>
    ...
    <?php
        if(isset($_SESSION['portfolio'])){
            $ID = $_SESSION['portfolio'];
        }
        /* Bootstrap core CSS */
        echo "<link href=\"css/css.php?id=$ID\" rel=\"stylesheet\">";

        /* Add custom CSS here */
        echo "<link href=\"css/css2.php?id=$ID\" rel=\"stylesheet\">";
                    ...
                    switch ($row['User_Type_ID']){
                        ...
                        case 2:
                            echo '<li class="active"><a href="index.php"><i class="fa fa-home"></i> Hoofdpagina</a></li>
                                ...
                                <li><a href="registration.php"><i class="fa fa-list-alt"></i> Registratie </a></li>';
                            if(isset($_SESSION['portfolio'])){
                                echo "<li <a href=\"home.php?id=\"><i class=\"fa fa-home\"></i> " . $row2['User_Name'] . '</a></li>';
                                echo '<li><a href="cv.php"><i class="fa fa-table"></i> CV en Werkervaring</a></li>';
                            }
                            break;
                        case 5:
