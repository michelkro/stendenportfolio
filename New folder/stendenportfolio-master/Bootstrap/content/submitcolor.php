<div id="page-wrapper">
        ...
        <?php
            ...
            $SQLstring = "UPDATE design SET Header_Color = '$header', Background = '$background', Menu_Colour = '$menu', Text_Colour = '$text', Font = '$font', Menuhover_Color	= '$menuhover', Textbox_Color	= '$menuhover'  WHERE User_ID =" .$row['User_ID'];
