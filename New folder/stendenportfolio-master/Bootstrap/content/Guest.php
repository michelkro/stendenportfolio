    ...
    <div id="wrapper">
      ...
      <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="index.php"><img src="img/stendenlogo.png" alt="logo" width="8%"> Stenden Portfolio </a>
        </div>
      ...
      <div id="page-wrapper">
        ...
        <div class="row">
            <div id="content">
                <div class="welkom">
                    <h1>Welkom op het Portfolio Systeem van Stenden Hogeschool</h1>
                </div>
            </div>
        </div><!-- /.row -->
