<div id="page-wrapper">
            ...
            <div id="body">
				...
				if(isset($_SESSION['portfolio'])){
						...
						//------------------------------------OUTPUT----------------------------------------------------
							...
							$query = "SELECT `Name`, `E-Mail`, `Message`, `DateTime` FROM `Guestbook` WHERE Publicity = 'Y' AND User_ID = ".$row2['User_ID'];
	...
	//---------------------------------------------------------------INPUT-----------------------------------------------
							...
							if(isset($_POST["submit"])){
								if(empty($_POST['name']) || empty($_POST['text']) || empty($_POST['mail']) ){
									echo "vul alles in";
								}
								else{
